...
class main:
    ...
    def __init__(self, master):
        ...
        self.mul = Button(self.master, text = "TWO PLAYERS",font=("Helvetica", 16), padx=32,pady=32,bg = "palegreen", fg = "maroon", command = self.mul)
...
class single_player:
    ...
    def __init__(self, root):
        ...
        self.button1 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button1.bind("<ButtonRelease-1>", self.task)
        self.button1.grid(row=0,column=0)

        self.button2 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button2.bind("<ButtonRelease-1>", self.task)
        self.button2.grid(row=0, column=1)

        self.button3 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button3.bind("<ButtonRelease-1>", self.task)
        self.button3.grid(row=0, column=2)

        self.button4 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button4.bind("<ButtonRelease-1>", self.task)
        self.button4.grid(row=1,column=0)

        self.button5 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button5.bind("<ButtonRelease-1>", self.task)
        self.button5.grid(row=1, column=1)

        self.button6 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button6.bind("<ButtonRelease-1>", self.task)
        self.button6.grid(row=1, column=2)

        self.button7 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button7.bind("<ButtonRelease-1>", self.task)
        self.button7.grid(row=2,column=0)

        self.button8 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button8.bind("<ButtonRelease-1>", self.task)
        self.button8.grid(row=2,column=1)

        self.button9 = Button(self.frame,padx=32,pady=32,bg="lightblue",fg="black")
        self.button9.bind("<ButtonRelease-1>", self.task)
        self.button9.grid(row=2,column=2)

        self.button10=Button(self.frame,padx=32,pady=32,fg="white",bg="red")
    ...
    #this funtion displays the text on the button
    ...
    #this function tells the user turn or the computers 
    ...
    #this function checks all the winning conditions
    ...
    def checkwin(self):
       ...
       if(self.board[0] != "   " and self.board[1] != "   "
                  ...
                  and self.board[8] != "   "):
         self.unbind()
         messagebox.showwarning("RESULT","game drawn")
         self.reset()
         self.bind()
         return 1

    #This gives the computer a turn
    ...
    #this end the program and shifts the window
    ...
    #this funtion impliments the reset button by placing the text on
    #the button to the original value
    ...
    #this funtion unbinds the button
...
class multi_player:
    ...
    def __init__(self,master):
        ...
        self.label=Label(self.frame, text='TIC TAC TOE',font=("Helvetica", 16), height=3, bg='maroon', fg='white')
        ...
        self.Start1=Button(self.frameb, text='RESET',font=("Helvetica", 12), height=3, command=self.start1,bg='pink', fg='red')
    ...
    def start1(self):
        ...
        #to distinguish whose turn is there
        self.i=0
