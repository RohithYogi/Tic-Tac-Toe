...
class single_player:
    ...
    def __init__(self, root1):
        ...
        self.B = Button(self.frame,padx=32,pady=32,fg="blue",bg="black",command=self.reset)
    ...
    def endProgram(self):
        self.root.destroy()
    def reset(self):
        self.button1.unbind("<ButtonRelease-1>", self.task)
        self.button2.unbind("<ButtonRelease-1>", self.task)
        self.button3.unbind("<ButtonRelease-1>", self.task)
        self.button4.unbind("<ButtonRelease-1>", self.task)
        self.button5.unbind("<ButtonRelease-1>", self.task)
        self.button6.unbind("<ButtonRelease-1>", self.task)
        self.button7.unbind("<ButtonRelease-1>", self.task)
        self.button8.unbind("<ButtonRelease-1>", self.task)
        self.button9.unbind("<ButtonRelease-1>", self.task)
